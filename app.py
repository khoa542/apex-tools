...
class ApexTools:
    def __init__(self):
        # Khởi tạo State cho Easter Eggs (Bí mật)
    ...
    def apply_styles(self):
        # Logic thay đổi giao diện bí mật
    ...
    def render_header(self):
        ...
        st.markdown('<marquee class="marquee-bar">System Ready | Engine: SymPy | All tools operational | High-precision mode active...</marquee>', unsafe_allow_html=True)
    ...
    def ui_generic(self, name, label, placeholder, callback):
        ...
        # Logic "Cheat Code" bí mật trong ô Input
        if inp.lower() == "matrix": 
    ...
    def ui_home(self):
        ...
        with c2:
            # Easter Egg Tàng hình (Click 5 lần sau dấu chấm của Commander)
            if st.button(" ", key="egg_trigger"):
    ...
    def ui_update_log(self):
        ...
        <table class="update-table">
            ...
            <tr><td>2026-03-28</td><td><b>Interface</b></td><td>Optimized for high-resolution displays. Removed version labels.</td></tr>
            <tr><td>2026-03-28</td><td><b>Core</b></td><td>Fixed 'Compute' button rendering across all solvers.</td></tr>
            <tr><td>2026-03-27</td><td><b>Math</b></td><td>Integrated SymPy 1.12 for complex symbolic manipulation.</td></tr>
        </table>
        """, unsafe_allow_html=True)

    def ui_tutorial(self): st.info("Use '^' for exponents (e.g., x^2). Always use '*' for multiplication.")
    def ui_health(self): st.success("System Health: 100% | CPU: Optimal | Engine: Online")
